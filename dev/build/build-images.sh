#!/usr/bin/env bash
#docker build -t my_nginx images/nginx
#docker build -t phpfpm images/php-fpm



# Tests if an image has already been built. Images like "nginx", "php-fpm", etc. don't have to be re-build often.
...
check_if_exists_and_build images/nginx
check_if_exists_and_build images/php-fpm